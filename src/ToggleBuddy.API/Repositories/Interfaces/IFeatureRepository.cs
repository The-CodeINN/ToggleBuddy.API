...
namespace ToggleBuddy.API.Repositories.Interfaces
{
    ...
    
    {
        public Task<Feature> CreateAsync(Feature feature);
         public Task<Feature> ShowAsync(Guid featureId);

        public  Task<Feature> UpdateFeatureAsync(Feature featureToUpdate);
        
        public Task<Feature> UpdateAsync(Feature feature,  Guid featureId);
